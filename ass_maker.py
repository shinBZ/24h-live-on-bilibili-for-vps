...
Dialogue: 2,0:00:00.00,9:00:00.00,right_down,,0,0,0,,基于VPS搭建\\N'''+'点播日期：'+time.strftime('%Y-%m-%d %H:%M:%S',time.localtime(time.time()))+'''
Dialogue: 2,0:00:00.00,9:00:00.00,left_up,,0,0,0,,已开源，源码见http://t.cn/EhCdHWZ\\N使用时请保留源码链接
